...
(see :ref:`lab_setup`). You can read about the detailed explanation of :ref:`components`.
Other instances of a Ceph Lab being used in a development or testing environment
